  ...
  return (
    ...
    <div className={styles.poll+" "+animateClass}>
      ...
      <div className={styles.options}>
        <div className={styles.rap}><Image alt="Choose Rap" src="/../public/rap.jpg" width={200} height={200} className={styles.rapImage}/><p>Rap</p></div>
        <div className={styles.divider}></div>
        <div className={styles.pop}><Image alt="Choose Pop" src="/../public/pop.jpg" width={200} height={200} className={styles.popImage}/><p>Pop</p></div>
      </div>
    </div>
    </>
  )
